/*
 ...
 ﻿﻿Methods:
 ﻿﻿A constructor that initializes the book details.
 ﻿﻿display () to output the book details to the console.
 Member Class:
 ﻿﻿Attributes: name (string), age (int), member ID (string).
 ﻿﻿Methods:
 ...
 Main Function:
 ﻿﻿Create an array of Book objects and an array of Member objects.
...
Use pointers to refer to and manipulate the book and member objects.
 ...
 ﻿﻿In the main function, create at least two Book objects and two Member objects.
